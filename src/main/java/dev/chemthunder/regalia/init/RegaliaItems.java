...
public interface RegaliaItems {
    ...
    Item CRIMSON_OBITUARY = create("crimson", new HalberdItem(ToolMaterials.GOLD, 7, -2.3f, new FabricItemSettings()
            .group(RegaliaItemGroup.MASON)
            .fireproof()
            .rarity(Rarity.UNCOMMON)
            ));

    Item WAYSTONME = create("waystone", new WaystoneItem(ToolMaterials.IRON, 6, -2.4f, new FabricItemSettings()
            .maxCount(1)
            .group(RegaliaItemGroup.MASON)
            .fireproof()
    ));
